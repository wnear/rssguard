    ...
    : QDialog(parent), m_oauth(nullptr), m_editableRoot(nullptr)
{
    ...
    connect(m_ui.m_txtAppId->lineEdit(), &BaseLineEdit::textChanged, this,
            &FormEditInoreaderAccount::checkOAuthValue);
    connect(m_ui.m_txtAppKey->lineEdit(), &BaseLineEdit::textChanged, this,
            &FormEditInoreaderAccount::checkOAuthValue);
    connect(m_ui.m_txtRedirectUrl->lineEdit(), &BaseLineEdit::textChanged, this,
            &FormEditInoreaderAccount::checkOAuthValue);
    connect(m_ui.m_txtUsername->lineEdit(), &BaseLineEdit::textChanged, this,
            &FormEditInoreaderAccount::checkUsername);
    ...
    connect(m_ui.m_buttonBox, &QDialogButtonBox::accepted, this,
            &FormEditInoreaderAccount::onClickedOk);
    connect(m_ui.m_buttonBox, &QDialogButtonBox::rejected, this,
            &FormEditInoreaderAccount::onClickedCancel);
...
void FormEditInoreaderAccount::onAuthError(const QString &error,
        const QString &detailed_description)
{
    Q_UNUSED(error)
