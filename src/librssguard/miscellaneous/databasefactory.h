...
private:
    ...
    bool mysqlUpdateDatabaseSchema(const QSqlDatabase &database,
                                   const QString &source_db_schema_version, const QString &db_name);
    ...
    // Updates database schema.
    bool sqliteUpdateDatabaseSchema(const QSqlDatabase &database,
