...
inline DuplicationAttributeCheck operator|(DuplicationAttributeCheck lhs,
        DuplicationAttributeCheck rhs)
{
...
public:
    explicit MessageObject(QSqlDatabase *db, const QString &feed_custom_id, int account_id,
