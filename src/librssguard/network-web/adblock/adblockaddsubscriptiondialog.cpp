    ...
    : QDialog(parent), m_ui(new Ui::AdBlockAddSubscriptionDialog)
{
    ...
    m_knownSubscriptions << Subscription(QSL("EasyList (English)"), ADBLOCK_EASYLIST_URL)
                         ...
                         << Subscription(QSL("EasyList Germany (German"),
                                         QSL("https://easylist.to/easylistgermany/easylistgermany.txt"))
                         ...
                         << Subscription(QSL("Filtros Nauscopicos (Spanish)"),
                                         QSL("http://abp.mozilla-hispano.org/nauscopio/filtros.txt"))
                         << Subscription(QSL("IsraelList (Hebrew)"),
                                         QSL("http://secure.fanboy.co.nz/israelilist/IsraelList.txt"))
                         ...
                         << Subscription(QSL("Schacks Adblock Plus liste (Danish)"),
                                         QSL("http://adblock.schack.dk/block.txt"))
                         << Subscription(QSL("Xfiles (Italian)"), QSL("http://mozilla.gfsolone.com/filtri.txt"))
                         << Subscription(QSL("EasyPrivacy (English)"),
                                         QSL("http://easylist-downloads.adblockplus.org/easyprivacy.txt"))
                         << Subscription(QSL("RU Adlist (Russian)"),
                                         QSL("https://easylist-downloads.adblockplus.org/advblock.txt"))
                         ...
                         << Subscription(QSL("Easylist China (Chinese)"),
                                         QSL("https://easylist-downloads.adblockplus.org/easylistchina.txt"))
