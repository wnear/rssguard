...
public:
    ...
    static QPair<QByteArray, QByteArray> generateBasicAuthHeader(const QString &username,
    ...
    static QNetworkReply::NetworkError downloadIcon(const QList<QString> &urls, int timeout,
            QIcon &output);
